...
<link rel="stylesheet" type="text/css" href="${contextPath}/themes/${themeName}/css/mobilecss.css" rel="stylesheet" />
<script src="${contextPath}/themes/${themeName}/js/jQuery.Min.js"></script>
<script src="${contextPath}/themes/${themeName}/js/JX.js"></script>
<script src="${contextPath}/themes/${themeName}/js/Site.js"></script>
</head>
<body>
