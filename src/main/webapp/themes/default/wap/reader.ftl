...
<#macro customizetop>
    <div class="top3">
        <ul>
            <li><a class="button blue r3" href="<#if chapter.preChapterno ==0>${article.url}<#else>${encodeURL("/reader?subdir=${chapter.subdir?c}&articleno=${chapter.articleno?c}&chapterno=${chapter.preChapterno?c}")}</#if>">上一章</a></li>
            ...
            <li><a class="button blue r3" href="<#if chapter.nextChapterno ==0>${article.url}<#else>${encodeURL("/reader?subdir=${chapter.subdir?c}&articleno=${chapter.articleno?c}&chapterno=${chapter.nextChapterno?c}")}</#if>">下一章</a></li>
        </ul>
    </div>
</#macro>
