    ...
    <div id="container">
        ...
        <section>
            <header class="netnovel-header">
                <h3>我的书架 &nbsp;&nbsp;- 您的书架可收藏 <s:property  value="maxBookcaseNum" /> 本，已收藏 <s:property  value="bookcaseNum" /> 本。</h3>
            </header>
            <form action="" method="post" name="checkform" id="checkform" onSubmit="return check_confirm();">
                <table class="mygrid" width="100%" align="center">
                  ...
                  <s:iterator value="bookcaseList" id="bookcase" status="rowstatus">
                  <tr>
                        ...
                        <td class="even"><a href="<s:url value="/info" ><s:param name="articleno" value="#bookcase.articleno" /></s:url>" target="_blank"><s:property value="#bookcase.articlename" /></a></td>
