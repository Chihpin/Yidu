        ...
        <section class="section board-list board-list-collapse">
            ...
            <div class="msgwin mgl_61" style="text-align:center;">
                <div class="blockcontent">
                    <div style="padding:10px"><br /><s:actionerror theme="simple"/><br />请 <a href="javascript:history.back(1)">返 回</a> 并修正或 <a href="<%=request.getContextPath()%>/index">返回首页</a><br /><br /></div>
                </div>
